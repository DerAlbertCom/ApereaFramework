...
namespace Aperea.Services
{
    ...
    {
        UserRegistrationResult(int value, string resultResourceStringName) : base(value, resultResourceStringName)
        {
        }

        public static readonly UserRegistrationResult Ok = new UserRegistrationResult(0, "UserRegistrationResult_Ok");
        public static readonly UserRegistrationResult Exists = new UserRegistrationResult(1, "UserRegistrationResult_Exists");
